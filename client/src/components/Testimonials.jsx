...
const Testimonials = () => {
  return (
    ...
    className='flex flex-col items-center justify-center text-center my-20 py-12 '>
         ...
         <h1 className='text-3xl sm:text-4xl font-semibold mb-2'>Customer Testimonal</h1>
         <p className='text-gray-500 mb-12 '>What Our User is Saying</p>

         <div className='flex flex-wrap gap-6'>
            {testimonialsData.map((testimonail,index)=>(
                <div className='bg-white/20 p-20 rounded-lg shadow-md order w-80 m-auto cursor-pointer 
