  ...
  return (
    ...
    <div>
      <div className='relative'>
          ...
          <span className={`absolute bottom-0 left-0 h-1 bg-blue-500 ${loading ? 'w-full transtion-all duration-[10s]': 'w-0'} `} />
      </div>
    ...
    text-sm p-0.5 m-10 rounded-full'>
      <input type="text" placeholder='Describe what yoy want to generate' className='flex-1 bg-transparent outline-none ml-8 
      max-sm:w-20  placeholder-color' />

      <button type='submit' className='bg-zinc-900 px-10 
      sm:px-16 py-3 rounded-full'>Generate</button>
    ...
    text-sm rounded-full p-0.5 mt-10'>
      ...
      <a href={image} download className='bg-zinc-900 cursor-pointer rounded-full px-10 py-3'>Download</a>
    </div>
